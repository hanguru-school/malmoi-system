...
const AttendancePage = () => {
  ...
  return (
    <div className="p-6 space-y-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-yellow-600">{stats.lateDays}일</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600">{stats.averageWorkHours.toFixed(1)}시간</p>
            </div>
      ...
      {/* Monthly Summary */}
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">월간 근태 요약</h3>
