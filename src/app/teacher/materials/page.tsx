...
export default function TeacherMaterialsPage() {
  ...
  const [typeFilter, setTypeFilter] = useState<'all' | 'document' | 'video' | 'image' | 'audio' | 'other'>('all');
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{materials.length}개</p>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <select
              value={typeFilter}
              onChange={(e) => setTypeFilter(e.target.value as 'all' | 'document' | 'video' | 'image' | 'audio' | 'other')}
                  ...
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-sm text-gray-500 mb-2">
                        ...
                        <span>업로드: {new Date(material.uploadDate).toLocaleDateString()}</span>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-2xl mx-4">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">자료명</label>
                  <input
                    type="text"
