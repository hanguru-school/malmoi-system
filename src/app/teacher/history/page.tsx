...
export default function TeacherHistoryPage() {
  ...
  const [statusFilter, setStatusFilter] = useState<'all' | 'with-review' | 'without-review'>('all');
      ...
      const mockClasses: ClassHistory[] = [
        {
          ...
          review: {
            rating: 5,
            content: '매우 만족스러운 수업이었습니다. 선생님이 친절하고 이해하기 쉽게 설명해주셔서 좋았습니다.',
            date: '2024-01-15',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <select
              value={statusFilter}
              onChange={(e) => setStatusFilter(e.target.value as 'all' | 'with-review' | 'without-review')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold text-gray-900">
                  {classes.filter(c => c.review && c.review.rating >= 4).length}
                </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          {currentClasses.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">수업 이력이 없습니다</h3>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-700">
                            {formatTime(classItem.startTime)} - {formatTime(classItem.endTime)} ({classItem.duration}분)
                          </span>
                        </div>
                        {classItem.review && (
                          <div className="flex items-center gap-1">
                            {renderStars(classItem.review.rating)}
                            <span className="text-sm text-gray-600">({classItem.review.rating}/5)</span>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium text-gray-900">{classItem.studentName}</span>
                        </div>
                        <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium text-gray-900">{classItem.location}</span>
                        </div>
                      </div>
                      ...
                      {classItem.review && (
                        <div className="border-t border-gray-200 pt-4">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-medium text-gray-900">학생 리뷰</span>
                          ...
                          <div className="bg-blue-50 rounded-lg p-3">
                            ...
                            <p className="text-sm text-gray-700 mb-2">{classItem.review.content}</p>
                            {classItem.review.studentResponse && (
                              <div className="border-t border-blue-200 pt-2 mt-2">
                                <p className="text-xs text-gray-500 mb-1">선생님 답변:</p>
                                <p className="text-sm text-gray-700">{classItem.review.studentResponse}</p>
                              </div>
                            )}
                          </div>
                        </div>
                      ...
                      {classItem.materials && classItem.materials.length > 0 && (
                        <div className="mt-4">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-medium text-gray-900">수업 자료</span>
                          </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl shadow-xl p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900">수업 상세 정보</h3>
                <button
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-medium text-gray-900">
                        {formatTime(selectedClass.startTime)} - {formatTime(selectedClass.endTime)} ({selectedClass.duration}분)
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-medium text-gray-900">{selectedClass.studentName}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-medium text-gray-900">{selectedClass.courseName}</div>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="p-3 bg-blue-50 rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-gray-600">({selectedClass.review.rating}/5)</span>
                      </div>
                      <p className="text-sm text-gray-700 mb-2">{selectedClass.review.content}</p>
                      {selectedClass.review.studentResponse && (
                        <div className="border-t border-blue-200 pt-2 mt-2">
                          <p className="text-xs text-gray-500 mb-1">선생님 답변:</p>
                          <p className="text-sm text-gray-700">{selectedClass.review.studentResponse}</p>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                {selectedClass.materials && selectedClass.materials.length > 0 && (
                  <div>
                    <div className="text-sm text-gray-600 mb-2">수업 자료</div>
                    <div className="flex flex-wrap gap-2">
