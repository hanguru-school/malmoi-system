...
const translations = {
  ja: {
    ...
    heroSubtitle:
      "教室でレッスンを受ける生徒のためのデジタル学習プラットフォーム",
    ...
    features: {
      ...
      reservation: {
        title: "簡単なレッスン予約",
        description:
          "希望の時間に希望の先生とレッスンを予約しましょう。リアルタイムで利用可能な時間を確認できます。",
        feature: "リアルタイム予約可能",
      },
      materials: {
        title: "レッスン資料管理",
        description:
          "レッスン資料をいつでも確認してダウンロードできます。復習に必要なすべての資料が準備されています。",
        feature: "24時間アクセス可能",
      },
      online: {
        title: "オンラインレッスン",
        description:
          "家でも教室でもレッスンを受けることができます。Zoomリンクでいつでもアクセスしてください。",
        feature: "Zoom連携",
      },
      progress: {
        title: "学習進捗追跡",
        description:
          "自分の学習進捗を一目で確認できます。どの部分をもっと勉強すべきか教えてくれます。",
        feature: "個人別カスタム分析",
      },
      communication: {
        title: "先生とのコミュニケーション",
        description:
          "レッスン後に疑問点をいつでも聞いてください。先生が親切に回答してくれます。",
        feature: "リアルタイムメッセージ",
      },
      review: {
        title: "レッスンレビュー",
        description:
          "レッスン後の感想を共有し、フィードバックを受け取りましょう。より良いレッスンのための貴重な意見です。",
        feature: "相互フィードバック",
      },
    },
    howItWorks: {
      ...
      step1: {
        title: "会員登録",
        description:
          "簡単な情報入力で会員登録を完了してください。先生がお勧めするアカウントで今すぐ始められます。",
      },
      step2: {
        title: "レッスン予約",
        description:
          "希望の時間と先生を選択してレッスンを予約してください。教室レッスンとオンラインレッスンの両方が可能です。",
      },
      step3: {
        title: "学習開始",
        description:
          "レッスン資料を事前に確認し、レッスン後には復習資料で学習効果を高めましょう。",
      },
    },
    testimonials: {
      title: "生徒の生々しいレビュー",
      ...
      student1: {
        name: "金民洙 (初級)",
        review:
          "レッスン予約が本当に簡単になりました！先生がお勧めする資料で事前に勉強してレッスンに参加すると理解度が格段に良くなりました。",
      },
      student2: {
        name: "李智恩 (中級)",
        review:
          "オンラインレッスンも教室レッスンと同じくらい良いです！家で快適にレッスンを受けることができ、レッスン資料もいつでも確認できます。",
      },
      student3: {
        name: "朴賢宇 (上級)",
        review:
          "学習進捗追跡機能が本当に役立ちます。どの部分が不足しているか一目で分かるので復習計画を立てやすくなりました。",
      },
    },
    finalCTA: {
    ...
    footer: {
      description:
        "教室でレッスンを受ける生徒のためのスマートな韓国語学習プラットフォーム",
      learningTools: "学習ツール",
  ...
  ko: {
    ...
    features: {
      ...
      reservation: {
        title: "간편한 수업 예약",
        description:
          "원하는 시간에 원하는 선생님과 수업을 예약하세요. 실시간으로 가능한 시간을 확인할 수 있습니다.",
        feature: "실시간 예약 가능",
      },
      materials: {
        title: "수업 자료 관리",
        description:
          "수업 자료를 언제든지 확인하고 다운로드할 수 있습니다. 복습에 필요한 모든 자료가 준비되어 있어요.",
        feature: "24시간 접근 가능",
      },
      online: {
        title: "온라인 수업",
        description:
          "집에서도 교실에서도 수업을 들을 수 있습니다. Zoom 링크로 언제든지 접속하세요.",
        feature: "Zoom 연동",
      },
      progress: {
        title: "학습 진도 추적",
        description:
          "나의 학습 진도를 한눈에 확인할 수 있습니다. 어느 부분을 더 공부해야 할지 알려드려요.",
        feature: "개인별 맞춤 분석",
      },
      communication: {
        title: "선생님과 소통",
        description:
          "수업 후 궁금한 점을 언제든지 물어보세요. 선생님이 친절하게 답변해드립니다.",
        feature: "실시간 메시지",
      },
      review: {
        title: "수업 리뷰",
        description:
          "수업 후 느낀 점을 공유하고 피드백을 받아보세요. 더 좋은 수업을 위한 소중한 의견입니다.",
        feature: "상호 피드백",
      },
    },
    howItWorks: {
      ...
      step1: {
        title: "회원가입",
        description:
          "간단한 정보 입력으로 회원가입을 완료하세요. 선생님이 추천해주신 계정으로 바로 시작할 수 있습니다.",
      },
      step2: {
        title: "수업 예약",
        description:
          "원하는 시간과 선생님을 선택해서 수업을 예약하세요. 교실 수업과 온라인 수업 모두 가능합니다.",
      },
      step3: {
        title: "학습 시작",
        description:
          "수업 자료를 미리 확인하고, 수업 후에는 복습 자료로 학습 효과를 높이세요.",
      },
    },
    testimonials: {
      title: "학생들의 생생한 후기",
      ...
      student1: {
        name: "김민수 (초급)",
        review:
          "수업 예약이 정말 쉬워졌어요! 선생님이 추천해주신 자료로 미리 공부하고 수업에 참여하니까 이해도가 훨씬 좋아졌습니다.",
      },
      student2: {
        name: "이지은 (중급)",
        review:
          "온라인 수업도 교실 수업만큼 좋아요! 집에서 편하게 수업을 들을 수 있고, 수업 자료도 언제든지 확인할 수 있어요.",
      },
      student3: {
        name: "박현우 (고급)",
        review:
          "학습 진도 추적 기능이 정말 유용해요. 어느 부분이 부족한지 한눈에 알 수 있어서 복습 계획을 세우기 쉬워졌습니다.",
      },
    },
    finalCTA: {
    ...
    footer: {
      description:
        "교실에서 수업을 듣는 학생들을 위한 스마트한 한국어 학습 플랫폼",
      learningTools: "학습 도구",
      communication: "소통",
      support: "지원",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  {language === "ja" ? "先生とのメッセージ" : "선생님과 메시지"}
                </li>
                <li>{language === "ja" ? "レッスンレビュー" : "수업 리뷰"}</li>
                <li>
                  {language === "ja" ? "学習フィードバック" : "학습 피드백"}
                </li>
