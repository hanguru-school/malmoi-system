...
async function seedTaggingData() {
  try {
    ...
    const student1 = createdUsers.find(u => u.student && u.email === 'student1@test.com');
    const student2 = createdUsers.find(u => u.student && u.email === 'student2@test.com');
    ...
    const uidDevices = [
      ...
      {
        userId: createdUsers.find(u => u.student && u.email === 'student1@test.com')?.id,
        uid: 'STUDENT001',
        deviceType: 'ic_card',
      },
      {
        userId: createdUsers.find(u => u.student && u.email === 'student2@test.com')?.id,
        uid: 'STUDENT002',
        deviceType: 'ic_card',
      }
    ];
