...
export async function GET(request) {
  ...
  const unassignedTeacherOnly = String(searchParams.get("unassignedTeacherOnly") || "") === "1";
  const notes = await listLessonNotesForAdmin({ lessonUnitId, studentId, unassignedTeacherOnly });
...
export async function POST(request) {
  ...
  try {
    ...
    const note = await createLessonNoteByAdmin(body || {}, {
