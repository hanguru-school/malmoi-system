...
const MessagesPage = () => {
  ...
  useEffect(() => {
    ...
    const mockRecipients: Recipient[] = [
      { id: '1', name: '김학생', type: 'student', email: 'student1@example.com' },
      { id: '2', name: '이학생', type: 'student', email: 'student2@example.com' },
      { id: '3', name: '김부모님', type: 'parent', email: 'parent1@example.com' },
      { id: '4', name: '이부모님', type: 'parent', email: 'parent2@example.com' },
      { id: '5', name: '박선생님', type: 'teacher', email: 'teacher1@example.com' },
      { id: '6', name: '최선생님', type: 'teacher', email: 'teacher2@example.com' },
    ];
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">학생, 학부모, 강사에게 메시지를 발송하고 관리하세요</p>
        </div>
        <button
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">전송 상태</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">수신자 유형</label>
            <select
              value={selectedType}
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">수신자 유형</th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredMessages.map((message) => (
                <tr key={message.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{message.sendDate}</td>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">수신자 유형</label>
                  <select
                    value={newMessage.recipientType}
                    onChange={(e) => setNewMessage(prev => ({ ...prev, recipientType: e.target.value as any }))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  >
                    <option value="student">학생</option>
                    <option value="parent">학부모</option>
