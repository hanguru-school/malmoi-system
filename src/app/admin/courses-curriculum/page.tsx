  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">코스/커리큘럼 관리</h1>
          <p className="text-lg text-gray-600">코스와 커리큘럼을 통합 관리하세요</p>
        </div>
        <button
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600">{curriculums.length}개</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-yellow-600">
                {formatCurrency(Math.round(courses.reduce((sum, c) => sum + c.price, 0) / courses.length))}원
              </p>
            </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">코스 및 커리큘럼 목록</h2>
        </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-4 mb-2">
                        ...
                        <span className={`px-2 py-1 text-sm rounded-full ${getStatusColor(course.status)}`}>
                      ...
                      <div className="flex items-center gap-6 text-sm text-gray-500">
                        ...
                        <span>최종 수정: {new Date(course.updatedAt).toLocaleDateString()}</span>
                      </div>
                    </div>
                ...
                {isExpanded && (
                  <div className="bg-gray-50 px-6 py-4">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-md font-semibold text-gray-900">커리큘럼 목록</h4>
                    ...
                    <div className="space-y-3">
                      {courseCurriculums.map((curriculum) => (
                        <div key={curriculum.id} className="flex items-center justify-between p-3 bg-white rounded-lg border">
                          <div className="flex items-center gap-4">
                            <span className="text-sm font-medium text-gray-500 w-8">#{curriculum.order}</span>
                            <div>
                              <h5 className="text-sm font-medium text-gray-900">{curriculum.name}</h5>
                              <p className="text-xs text-gray-500">{curriculum.description}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-4">
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${getTypeColor(curriculum.type)}`}>
                              {getTypeText(curriculum.type)}
                            </span>
                            <span className="text-sm text-gray-500">{curriculum.estimatedTime}분</span>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl mx-4">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-lg font-semibold text-gray-900">새 코스 추가</h3>
              <button
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">수강료</label>
                  <input
                    type="number"
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    placeholder="수강료"
