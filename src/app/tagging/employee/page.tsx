...
export default function EmployeeTaggingPage() {
  ...
  const [currentResult, setCurrentResult] = useState<EmployeeTaggingResult | null>(null);
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-6">
          ...
          <p className="text-sm text-gray-500 mt-4 text-center">
            {employeeType === 'teacher' ? '선생님' : '사무직원'}의 NFC/FeliCa 카드를 리더기에 태그해주세요
          </p>
        </div>
              ...
              {currentResult.employee && (
                <div className="text-center mb-4">
                  <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <span className="text-lg font-medium">{currentResult.employee.name}</span>
                  </div>
                  <div className="text-sm text-gray-600">
                    {currentResult.employee.role === 'teacher' ? '선생님' : '사무직원'}
                  </div>
                </div>
              )}
              ...
              {currentResult.transportationAllowance && (
                <div className="text-center mb-4 p-3 bg-blue-50 rounded-lg">
                  <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <span className="font-medium text-blue-800">교통비 정보</span>
                  </div>
                  ...
                  <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">{lesson.serviceName}</div>
                      </div>
                    </div>
                    <div className="text-sm text-gray-600">
                      {lesson.time}
