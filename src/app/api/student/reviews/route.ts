    ...
    const reviews = [
      {
        ...
        courseName: '기초 일본어',
        content: '오늘은 기초 문법을 배웠습니다. は와 が의 차이점을 이해하기 어려웠지만 선생님이 쉽게 설명해주셔서 도움이 되었습니다.',
        rating: 5,
        teacherResponse: '열심히 공부하는 모습이 보기 좋습니다. 다음 수업에서도 궁금한 점이 있으면 언제든 질문해주세요!',
      ...
      },
      {
        ...
        courseName: '일본어 회화',
        content: '회화 연습을 많이 했습니다. 실제 상황에서 사용할 수 있는 표현들을 배워서 실용적이었습니다.',
        rating: 4,
        teacherResponse: '회화 실력이 많이 늘었습니다. 더 자연스러운 일본어를 구사할 수 있게 되었네요.',
      ...
      },
      {
        ...
        courseName: '고급 일본어',
        content: '한자 학습이 어려웠지만 체계적으로 배울 수 있어서 좋았습니다. 복습이 중요하다는 것을 깨달았습니다.',
        rating: 4,
        teacherResponse: '한자 학습은 꾸준함이 중요합니다. 매일 조금씩이라도 복습하는 습관을 들이세요.',
        studentResponse: undefined
      }
    ];
