...
export default function EnhancedReviewManagementPage() {
  ...
  const [filterStatus, setFilterStatus] = useState<
    "all" | "unresponded" | "responded" | "reported"
  >("all");
      ...
      const mockReviews: Review[] = [
        {
          ...
          rating: 5,
          content:
            "문법 설명이 매우 명확했습니다. 실습도 충분히 할 수 있어서 좋았습니다. 다음 수업도 기대됩니다!",
        ...
        },
        {
          ...
          rating: 4,
          content:
            "회화 연습이 재미있었고, 선생님이 친절하게 가르쳐주셨습니다. 조금 더 실습 시간이 있었으면 좋겠어요.",
          ...
          response: {
            ...
            content:
              "감사합니다! 다음 수업에서는 더 많은 실습 시간을 준비하겠습니다. 열심히 공부해주셔서 고맙습니다.",
            isPublic: true,
          },
          isLinkedToGoogle: true,
          isReported: false,
        },
        {
          ...
          rating: 3,
          content:
            "수업은 괜찮았지만, 조금 빠르게 진행되어서 따라가기 어려웠습니다.",
        ...
        },
        {
          ...
          rating: 5,
          content:
            "정말 훌륭한 수업이었습니다! 선생님의 설명이 너무 명확해서 이해하기 쉬웠어요.",
        ...
        },
        {
          ...
          rating: 2,
          content:
            "수업이 너무 어려웠고, 선생님이 제 질문에 제대로 답변하지 않으셨습니다.",
  ...
  useEffect(() => {
    ...
    if (filterTeacher) {
      filtered = filtered.filter(
        (review) => review.teacherName === filterTeacher,
      );
    }
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            학생 리뷰를 관리하고 응답하며 Google 리뷰와 연동할 수 있습니다.
          </p>
        </div>
