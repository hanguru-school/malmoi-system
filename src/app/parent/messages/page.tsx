...
import { MessageSquare, Send, Search, User, Calendar, Paperclip, MoreVertical, Reply, Trash2 } from 'lucide-react';
...
const mockMessages = [
  {
    ...
    senderType: 'teacher',
    subject: '수학 과제 관련 문의',
    content: '안녕하세요. 민수 어머니, 오늘 수학 과제에서 민수가 어려워하는 부분이 있어서 연락드립니다. 분수 개념을 이해하는데 조금 더 도움이 필요할 것 같아요. 혹시 집에서도 추가로 설명해주실 수 있으시면 좋겠습니다.',
  ...
  },
  {
    ...
    senderType: 'teacher',
    subject: '영어 발음 교정 안내',
    content: '민수 어머니께, 오늘 영어 수업에서 민수의 발음이 많이 좋아졌습니다. 특히 "th" 발음을 정말 잘 하고 있어요. 계속해서 연습해주시면 더욱 좋을 것 같습니다.',
  ...
  },
  {
    ...
    content: '다음 주 과학 실험을 위해 준비물이 필요합니다. 실험실에서 사용할 안전 고글과 실험복을 준비해주시면 감사하겠습니다. 실험은 화학 반응에 대한 내용입니다.',
  ...
  },
  {
    ...
    senderType: 'teacher',
    subject: '국어 독서 과제 확인',
    content: '민수가 제출한 독서 감상문을 확인했습니다. 정말 잘 썼네요! 특히 주인공의 감정 변화를 잘 분석했고, 자신의 생각도 잘 표현했습니다. 계속해서 독서 습관을 유지해주세요.',
  ...
  },
  {
    ...
    senderType: 'teacher',
    subject: '음악 발표회 안내',
    content: '다음 달 음악 발표회가 예정되어 있습니다. 민수가 피아노 연주를 하게 될 예정이니, 연습을 더 열심히 해주시면 좋겠습니다. 발표회 일정은 추후 상세히 안내드리겠습니다.',
...
export default function MessagesPage() {
  ...
  const filteredMessages = mockMessages.filter(message => {
    ...
    const matchesTeacher = selectedTeacher === '전체' || message.sender === selectedTeacher;
    const matchesPriority = selectedPriority === '전체' || message.priority === selectedPriority;
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500 mt-1">{message.sender} • {message.subjectName}</p>
                    </div>
        ...
        <div className="lg:col-span-2">
          {selectedMessage ? (
                ...
                <div className="flex items-start justify-between mb-6">
                  <div>
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-600">
                      <span>보낸 사람: {selectedMessage.sender} ({selectedMessage.subjectName})</span>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-12 text-center">
              ...
              <p className="text-gray-500">메시지를 선택하여 내용을 확인하세요</p>
            </div>
          )}
        </div>
      </div>
      ...
      {showCompose && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl mx-4">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">새 메시지 작성</h3>
