...
export default function RegisterPage() {
  ...
  const [role, setRole] = useState<
    "STUDENT" | "PARENT" | "TEACHER" | "STAFF" | "ADMIN"
  >("STUDENT");
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder={
                  language === "ko" ? "example@email.com" : "example@email.com"
                }
              />
              {fieldErrors.email && (
            ...
            <div>
              ...
              <input
                ...
                placeholder={
                  language === "ko" ? "010-1234-5678" : "090-1234-5678"
                }
              />
              {fieldErrors.phone && (
