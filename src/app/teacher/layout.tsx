...
export default function TeacherLayout({
  ...
  const notifications = [
    { id: 1, message: '새로운 수업 예약이 있습니다.', time: '5분 전', read: false },
    { id: 2, message: '학생 노트 작성이 요청되었습니다.', time: '10분 전', read: false },
    { id: 3, message: '급여 지급이 완료되었습니다.', time: '1시간 전', read: true },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* 사이드바 */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-green-900 shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
