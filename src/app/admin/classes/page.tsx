...
const AdminClassesPage = () => {
  ...
  useEffect(() => {
    ...
    const mockStudents: Student[] = [
      { id: 'ST001', name: '김민수', email: 'kim@example.com', grade: '중2', attendance: 85 },
      { id: 'ST002', name: '박지영', email: 'park@example.com', grade: '고1', attendance: 92 },
      { id: 'ST003', name: '이준호', email: 'lee@example.com', grade: '중3', attendance: 78 },
      { id: 'ST004', name: '정수진', email: 'jung@example.com', grade: '고2', attendance: 95 },
      { id: 'ST005', name: '최동현', email: 'choi@example.com', grade: '중1', attendance: 88 },
      { id: 'ST006', name: '한소영', email: 'han@example.com', grade: '고3', attendance: 90 }
    ];
  ...
  const filteredClasses = classes.filter(cls => {
    ...
    const matchesCourse = courseFilter === 'all' || cls.courseName === courseFilter;
  ...
  const handleCreateClass = () => {
    if (newClassData.name && newClassData.courseName && newClassData.teacherName) {
  ...
  const handleUpdateClass = () => {
    if (editingClass && editingClass.name && editingClass.courseName && editingClass.teacherName) {
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">수업 정보를 관리하고 새로운 수업을 생성할 수 있습니다.</p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-blue-600">{classStats.completed}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-red-600">{classStats.cancelled}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div key={cls.id} className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-sm text-gray-500">{cls.courseName}</span>
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex items-center text-sm text-gray-500">
                    ...
                    <span>
                      ...
                      <span className={`ml-2 inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getOccupancyColor(cls.currentStudents, cls.maxStudents)}`}>
                ...
                <div className="text-sm text-gray-500 mb-4">
                  <p>기간: {cls.startDate} ~ {cls.endDate}</p>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewClassData({...newClassData, courseName: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewClassData({...newClassData, price: parseInt(e.target.value)})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="0"
                  />
                </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setNewClassData({...newClassData, status: e.target.value as Class['status']})}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
                  <option value="active">진행중</option>
                  <option value="completed">완료</option>
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <button
                  ...
                  disabled={!newClassData.name || !newClassData.courseName || !newClassData.teacherName}
      ...
      {selectedClass && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-gray-900">수업 상세 정보</h2>
              <button
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <span className="text-sm font-medium text-gray-500">수업명:</span>
                      <span className="ml-2 text-sm text-gray-900">{selectedClass.name}</span>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-gray-500">코스:</span>
                      <span className="ml-2 text-sm text-gray-900">{selectedClass.courseName}</span>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-gray-500">담당 선생님:</span>
                      <span className="ml-2 text-sm text-gray-900">{selectedClass.teacherName}</span>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-gray-500">상태:</span>
                      <span className={`ml-2 inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(selectedClass.status)}`}>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <span className="ml-2 text-sm text-gray-900">{selectedClass.schedule}</span>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-gray-500">수업장소:</span>
                      <span className="ml-2 text-sm text-gray-900">{selectedClass.location}</span>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-gray-500">기간:</span>
                      <span className="ml-2 text-sm text-gray-900">{selectedClass.startDate} ~ {selectedClass.endDate}</span>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-gray-500">가격:</span>
                      <span className="ml-2 text-sm text-gray-900">{selectedClass.price.toLocaleString()}원</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">학생 현황</h3>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <span className="text-sm font-medium text-gray-500">등록 학생:</span>
                      <span className="ml-2 text-lg font-bold text-gray-900">
                        {selectedClass.currentStudents}/{selectedClass.maxStudents}명
                      </span>
                    </div>
                    <span className={`inline-flex px-3 py-1 text-sm font-semibold rounded-full ${getOccupancyColor(selectedClass.currentStudents, selectedClass.maxStudents)}`}>
                      {Math.round((selectedClass.currentStudents / selectedClass.maxStudents) * 100)}% 등록률
                    </span>
                  </div>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {students.slice(0, selectedClass.currentStudents).map((student) => (
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setEditingClass({...editingClass, status: e.target.value as Class['status']})}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
                  <option value="active">진행중</option>
                  <option value="completed">완료</option>
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <button
                  ...
                  disabled={!editingClass.name || !editingClass.courseName || !editingClass.teacherName}
