              ...
              <>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border-l-4 border-blue-500 shadow-sm">
                  ...
                  <p className="text-gray-700 leading-relaxed pl-11">
                    한구루 스쿨 예약 시스템(이하 "서비스")을 이용해 주셔서 감사합니다. 
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-lg border-l-4 border-green-500 shadow-sm">
                  ...
                  <ul className="space-y-2 text-gray-700 pl-11">
                    <li className="flex items-start">
                      ...
                      <span>서비스 이용을 위해 정확한 정보로 회원가입을 해야 합니다.</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-500 mr-3 mt-1 text-lg">•</span>
                      <span>계정 정보는 본인이 직접 관리해야 하며, 타인에게 양도할 수 없습니다.</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-500 mr-3 mt-1 text-lg">•</span>
                      <span>계정 도용이나 무단 사용이 발견되면 즉시 서비스 이용이 제한될 수 있습니다.</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-gradient-to-r from-purple-50 to-violet-50 p-6 rounded-lg border-l-4 border-purple-500 shadow-sm">
                  ...
                  <ul className="space-y-2 text-gray-700 pl-11">
                    ...
                    <li className="flex items-start">
                      <span className="text-purple-500 mr-3 mt-1 text-lg">•</span>
                      <span>무단 결석 시 향후 예약에 제한이 있을 수 있습니다.</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-lg border-l-4 border-red-500 shadow-sm">
                  ...
                  <ul className="space-y-2 text-gray-700 pl-11">
                    <li className="flex items-start">
                      ...
                      <span>서비스 이용 규칙을 위반하는 경우 이용이 제한될 수 있습니다.</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-500 mr-3 mt-1 text-lg">•</span>
                ...
                <div className="bg-gradient-to-r from-gray-50 to-slate-50 p-6 rounded-lg border-l-4 border-gray-500 shadow-sm">
                  <h2 className="text-xl font-bold text-gray-900 mb-3 flex items-center">
                    <span className="bg-gray-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-3">6</span>
                    책임 제한
                  </h2>
                  <p className="text-gray-700 leading-relaxed pl-11">
                ...
                <div className="bg-gradient-to-r from-indigo-50 to-blue-50 p-6 rounded-lg border-l-4 border-indigo-500 shadow-sm">
                  <h2 className="text-xl font-bold text-gray-900 mb-3 flex items-center">
                    <span className="bg-indigo-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-3">8</span>
                    문의 및 연락처
                  </h2>
                  <p className="text-gray-700 leading-relaxed pl-11">
                    서비스 이용과 관련된 문의사항은 관리자에게 연락해 주시기 바랍니다.
                  </p>
                </div>
              </>
            ) : (
              <>
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-lg border-l-4 border-green-500 shadow-sm">
                  ...
                  <ul className="space-y-2 text-gray-700 pl-11">
                    <li className="flex items-start">
                      <span className="text-green-500 mr-3 mt-1 text-lg">•</span>
                      <span>サービス利用のため、正確な情報で会員登録を行う必要があります。</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-500 mr-3 mt-1 text-lg">•</span>
                      <span>アカウント情報は本人が直接管理し、第三者に譲渡することはできません。</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-500 mr-3 mt-1 text-lg">•</span>
                      <span>アカウントの不正使用が発見された場合、即座にサービス利用が制限される場合があります。</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-gradient-to-r from-purple-50 to-violet-50 p-6 rounded-lg border-l-4 border-purple-500 shadow-sm">
                  ...
                  <ul className="space-y-2 text-gray-700 pl-11">
                    ...
                    <li className="flex items-start">
                      <span className="text-purple-500 mr-3 mt-1 text-lg">•</span>
                      <span>無断欠席の場合、今後の予約に制限が設けられる場合があります。</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-lg border-l-4 border-red-500 shadow-sm">
                  ...
                  <ul className="space-y-2 text-gray-700 pl-11">
                    <li className="flex items-start">
                      <span className="text-red-500 mr-3 mt-1 text-lg">•</span>
                      <span>サービス利用規則に違反する場合、利用が制限される場合があります。</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-500 mr-3 mt-1 text-lg">•</span>
                      <span>システムに悪影響を与える行為は禁止されています。</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-500 mr-3 mt-1 text-lg">•</span>
                      <span>第三者の権利を侵害する行為は禁止されています。</span>
                    </li>
                  </ul>
                </div>
