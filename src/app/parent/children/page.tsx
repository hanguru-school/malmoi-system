          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{children.length}명</p>
              </div>
                  ...
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-4 mb-2">
                        ...
                        <span className={`px-2 py-1 rounded-full text-sm font-medium ${getStatusColor(child.status)}`}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{child.currentCourse}</p>
                        </div>
                        <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{child.attendanceRate}%</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-600">진행률</p>
                          <p className={`font-medium ${getProgressColor(child.progress)}`}>
                            {child.progress}%
                          </p>
                        </div>
                        <div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-2xl mx-4">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold text-gray-900">아이 추가</h3>
                <button
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">초기 코스</label>
                  <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
