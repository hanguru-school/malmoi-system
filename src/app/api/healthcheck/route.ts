  ...
  try {
    ...
    const healthData = {
      ...
      database: {
        ...
        host:
          process.env.DB_HOST ||
          "malmoi-system-db.crooggsemeim.ap-northeast-1.rds.amazonaws.com",
      },
      cognito: {
        ...
        userPoolId:
          process.env.COGNITO_USER_POOL_ID || "ap-northeast-1_wtjdDdEJ5",
      },
      overall: {
        status:
          dbCheck.success && cognitoCheck.success && envValidation.isValid
            ? "healthy"
            : "unhealthy",
