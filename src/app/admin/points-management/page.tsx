...
export default function PointsManagementPage() {
  ...
  const fetchTransactions = async (studentId: string) => {
    try {
      const response = await fetch(`/api/admin/points/transactions/${studentId}`);
      const data = await response.json();
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-red-50 p-6">
      <div className="max-w-7xl mx-auto">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <div className="font-semibold text-purple-600">{student.points}점</div>
                ...
                <div className="bg-purple-50 rounded-lg p-4 mb-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-2xl font-bold text-purple-900">{selectedStudent.points}점</div>
                    </div>
                    ...
                    transactions.map((transaction) => (
                      ...
                      >
                        ...
                        <div className={`font-semibold ${
                          ...
                          {transaction.type === 'earn' ? '+' : '-'}{transaction.amount}점
                        </div>
                      </div>
                    ))
                  )}
        ...
        {showAddPoints && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-6 max-w-md mx-4">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">포인트 적립</h3>
        ...
        {showUsePoints && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-6 max-w-md mx-4">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">포인트 사용</h3>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    사용 포인트
