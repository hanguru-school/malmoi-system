        ...
        const mockHomework: Homework[] = [
          {
            id: '1',
            title: '조사 연습 문제',
            description: '주격 조사 "이/가"와 목적격 조사 "을/를"을 올바르게 사용하는 연습을 해보세요.',
            dueDate: '2024-01-20',
            status: 'pending',
            courseName: '기초 한국어',
            teacherName: '김선생님',
            ...
            questions: [
              {
                ...
                question: '다음 중 올바른 조사를 선택하세요: "저는 학생( )입니다."',
                options: ['이', '가', '을', '를'],
                answer: '가'
              },
              {
                id: 'q2',
                type: 'text',
                question: '다음 문장을 완성하세요: "저는 한국어( ) 공부합니다."',
                answer: '를'
              }
            ]
          },
          {
            id: '2',
            title: '자기소개 문장 만들기',
            description: '자기소개 표현을 사용하여 3문장 이상의 자기소개를 작성해보세요.',
            dueDate: '2024-01-18',
            status: 'submitted',
            courseName: '실용 한국어',
            teacherName: '박선생님',
            ...
            questions: [
              {
                ...
                answer: '안녕하세요. 저는 마리아입니다. 저는 스페인에서 왔습니다. 한국어를 배우고 싶어서 이 학교에 다니고 있습니다.'
              }
            ],
            ...
            questions: [
              {
                id: 'q1',
                type: 'audio_recording',
                question: '다음 단어들을 발음해주세요: 안녕하세요, 감사합니다, 미안합니다'
              }
            ]
          }
        ];
    ...
    try {
      ...
      setHomework(prev => prev.map(hw => 
        hw.id === selectedHomework.id 
          ? { ...hw, status: 'submitted', submittedAt: new Date().toISOString() }
          : hw
      ));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6">
      <div className="max-w-6xl mx-auto">
        {/* 헤더 */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">숙제 확인 및 제출</h1>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
              <div className="bg-blue-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-blue-600">{stats.totalAssigned}개</div>
              </div>
              ...
              <div className="bg-yellow-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-yellow-600">{stats.pending}개</div>
              </div>
              ...
              <div className="bg-red-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-red-600">{stats.overdue}개</div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">평균 점수</h3>
            ...
            {stats.weakAreas.length > 0 && (
              <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium text-yellow-800">개선이 필요한 영역</span>
                </div>
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${getDifficultyColor(hw.difficulty)}`}>
                        {hw.difficulty === 'easy' ? '쉬움' : 
                         hw.difficulty === 'medium' ? '보통' : '어려움'}
                      </span>
                    </div>
                  </div>
                  <div className="text-right">
                    ...
                    <div className={`text-sm font-medium ${
                      new Date(hw.dueDate) < new Date() ? 'text-red-600' : 'text-gray-900'
                    }`}>
                ...
                {hw.score !== undefined && (
                  <div className="mb-4 p-3 bg-blue-50 rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-blue-800">점수: {hw.score}점</span>
                    </div>
                    {hw.feedback && (
                      <p className="text-sm text-blue-700 mt-1">{hw.feedback}</p>
                    )}
                  </div>
                )}
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  ...
                  {hw.submittedAt && (
                    <div className="text-sm text-gray-500">
                      제출일: {new Date(hw.submittedAt).toLocaleDateString('ko-KR')}
                    </div>
                  )}
                </div>
              </div>
