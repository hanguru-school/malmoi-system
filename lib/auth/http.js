...
const DEFAULT_MAIL_BASE_URL = "https://portal.hanguru.school";
const LEGACY_MAIL_BASE_URL_HOST = "portal.hanguru.blog";
const CANONICAL_MAIL_BASE_URL_HOST = "portal.hanguru.school";
...
function normalizePortalDomain(value) {
  ...
  try {
    ...
    if (String(url.hostname || "").toLowerCase() === LEGACY_MAIL_BASE_URL_HOST) {
      url.hostname = CANONICAL_MAIL_BASE_URL_HOST;
      url.protocol = "https:";
    }
