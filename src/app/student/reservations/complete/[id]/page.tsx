...
export default function ReservationCompletePage() {
  ...
  const loadReservation = async () => {
    try {
      ...
      setError(error instanceof Error ? error.message : '예약 정보를 불러오는 중 오류가 발생했습니다.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">예약 정보</h2>
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900">
                    ...
                    {reservation.teacher?.rating && (
                      <span className="ml-2 text-yellow-500">★ {reservation.teacher.rating}</span>
                    )}
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              {reservation.course && (
                <div>
                  ...
                  <p className="font-medium text-gray-900">{reservation.course.name}</p>
                  <p className="text-sm text-gray-600">{reservation.course.description}</p>
                </div>
              )}
              ...
              {reservation.classroom && (
                <div>
                  ...
                  <p className="font-medium text-gray-900">{reservation.classroom}</p>
                </div>
              )}
              ...
              {reservation.notes && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{reservation.notes}</p>
                  </div>
                </div>
              )}
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h3 className="text-xl font-semibold text-gray-900 mb-6">예약 관리</h3>
