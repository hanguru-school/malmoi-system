              ...
              <div className="mt-1 space-y-1">
                {dayReservations.slice(0, 3).map(reservation => (
                   ...
                   >
                    ...
                    <div className="text-gray-500 truncate">{reservation.teacher.name}</div>
                  </div>
                ))}
    ...
    return (
      <div className="grid grid-cols-7 gap-1">
        ...
        {days.map((date, dayIndex) => {
          ...
          return (
            <div key={dayIndex} className="min-h-[600px] p-2 border border-gray-200">
              {dayReservations.map(reservation => (
                 ...
                 >
                  ...
                  <div className="text-xs text-gray-500">{reservation.teacher.name}</div>
                  <div className="text-xs text-gray-400">{reservation.location}</div>
                </div>
              ))}
            </div>
          );
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">전체 예약 캘린더</h1>
            <p className="text-lg text-gray-600">모든 수업 예약을 한눈에 확인하세요</p>
          </div>
                  ...
                  {teachers.map(teacher => (
                    <label key={teacher.id} className="flex items-center">
                      <input
                        ...
                        onChange={() => handleFilterChange('teachers', teacher.id)}
