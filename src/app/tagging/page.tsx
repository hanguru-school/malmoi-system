      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900">UID 태깅 시스템</h1>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">디바이스 선택</h2>
        ...
        {/* 관리 링크 */}
        <div className="bg-white rounded-2xl shadow-xl p-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">관리 기능</h3>
        ...
        <div className="bg-blue-50 rounded-2xl p-6 mt-8">
          ...
          <div className="space-y-2 text-blue-800">
            ...
            <p>• 태깅 시 예약 상태, 정기권 잔여량, 포인트 적립이 자동으로 처리됩니다</p>
            <p>• 관리자는 태깅 관리 페이지에서 모든 로그와 통계를 확인할 수 있습니다</p>
          </div>
        </div>
      </div>
    </div>
