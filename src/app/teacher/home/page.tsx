      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-900 text-center">수업 노트 작성</span>
          </Link>
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-900 text-center">오늘의 수업 확인</span>
          </Link>
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-900 text-center">수업 노트 관리</span>
          </Link>
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-900 text-center">일정 관리</span>
          </Link>
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-2xl font-bold text-gray-900">{stats?.monthlyClasses}회</div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">최근 수업 노트</h3>
            <Link href="/teacher/notes" className="text-sm text-blue-600 hover:text-blue-700">
              전체보기 →
            </Link>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/teacher/reservations" className="text-sm text-blue-600 hover:text-blue-700">
              전체보기 →
            </Link>
          </div>
          <div className="space-y-3">
            {recentReservations.map((reservation) => (
              <div key={reservation.id} className="p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-medium text-gray-900">{reservation.studentName}</span>
                  <span className="text-sm text-gray-500">{reservation.time}</span>
                </div>
                <div className="text-sm text-gray-600">{reservation.subject}</div>
