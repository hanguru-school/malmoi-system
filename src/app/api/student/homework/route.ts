    ...
    const homework = [
      {
        id: 'hw_1',
        title: '기초 문법 연습',
        description: 'JLPT N5 문법 문제 10문제를 풀어보세요. 1. は/が의 차이점 2. です/だ의 사용법 3. て형 활용',
      ...
      },
      {
        id: 'hw_2',
        title: '회화 연습',
        description: '일상적인 대화 상황에서 사용할 수 있는 표현들을 연습해보세요. 자기소개, 취미, 가족 소개 등',
      ...
      },
      {
        id: 'hw_3',
        title: '한자 학습',
        description: '기초 한자 20개를 학습하고 각각의 의미와 음을 외워보세요. 人, 大, 小, 上, 下 등',
