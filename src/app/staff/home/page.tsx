      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-pink-50 to-red-50 flex items-center justify-center p-6">
        <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            ...
            <br />
            현재 권한: {user.role === 'admin' ? '관리자' : user.role === 'teacher' ? '강사' : user.role === 'student' ? '학생' : user.role}
          </p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-2xl font-bold text-gray-900">{stats?.todayWorkHours}시간</div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-2xl font-bold text-green-600">{stats?.completedTasks}건</div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-2xl font-bold text-yellow-600">{stats?.pendingTasks}건</div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-2xl font-bold text-purple-600">{stats?.monthlyWorkHours}시간</div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-semibold text-gray-900">오늘의 업무 기록</h2>
            <Link
              href="/staff/work-log"
                ...
                >
                  <div className="flex items-center space-x-4">
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-900">{work.startTime}</div>
                      <div className="text-xs text-gray-500">{work.duration}분</div>
                    </div>
                    
                    <div className="flex-1">
                      <div className="font-medium text-gray-900">{work.workTitle}</div>
                      <div className="text-sm text-gray-600">{work.workContent}</div>
                      <div className="flex items-center gap-2 mt-1">
                        <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${getWorkTypeColor(work.workType)}`}>
        ...
        <div className="space-y-6">
          {/* 권한 정보 */}
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">권한 정보</h2>
            <div className="space-y-3">
            ...
            <div className="space-y-3">
              {permissions?.canViewReservations && (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-blue-700">예약 확인 및 관리</div>
                  </div>
              ...
              {permissions?.canSendMessages && (
                ...
                >
                  ...
                  <div>
                    <div className="font-medium text-green-900">메시지 발송</div>
                    <div className="text-sm text-green-700">학생 및 학부모 연락</div>
                  </div>
