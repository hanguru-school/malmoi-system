...
import { Language, getStoredLanguage, setStoredLanguage, getTranslation } from '@/lib/i18n';
          ...
          <div className="py-1">
            <button
              ...
              className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 ${
                currentLanguage === 'ko' ? 'bg-blue-50 text-blue-700' : 'text-gray-700'
              }`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 ${
                currentLanguage === 'ja' ? 'bg-blue-50 text-blue-700' : 'text-gray-700'
              }`}
            >
