      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">비밀번호 변경 및 보안 설정을 관리하세요</p>
          </div>
          <Link
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              {twoFactorEnabled ? (
                <div className="flex items-center gap-2 text-green-600">
                  ...
                  <span className="text-sm">2단계 인증이 활성화되어 있습니다</span>
                </div>
              ) : (
                <div className="flex items-center gap-2 text-gray-600">
                  <AlertTriangle className="w-4 h-4" />
                  <span className="text-sm">2단계 인증이 비활성화되어 있습니다</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-semibold text-gray-900">로그인 세션</h2>
            </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
            ...
            <ul className="space-y-2 text-sm text-blue-800">
              <li>• 강력한 비밀번호를 사용하세요 (영문, 숫자, 특수문자 조합)</li>
