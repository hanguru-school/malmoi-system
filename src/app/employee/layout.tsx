...
const navigation = [
  { name: '내 수업 일정', href: '/employee', icon: Calendar },
  { name: '수업 이력', href: '/employee/history', icon: Clock },
  { name: '급여 내역', href: '/employee/salary', icon: DollarSign },
  { name: '근태 확인', href: '/employee/attendance', icon: FileText },
  { name: '내 정보', href: '/employee/profile', icon: User },
];
...
export default function EmployeeLayout({
  ...
  const notifications = [
    { id: 1, message: '새로운 수업이 예약되었습니다.', time: '5분 전', read: false },
    { id: 2, message: '급여 정산이 완료되었습니다.', time: '1시간 전', read: false },
    { id: 3, message: '근태 확인이 요청되었습니다.', time: '2시간 전', read: true },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-blue-900 shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-blue-800">
          <h1 className="text-xl font-bold text-white">직원 포털</h1>
          <button
            onClick={() => setSidebarOpen(false)}
          ...
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden sm:block">
                ...
                <div className="text-lg font-semibold text-gray-900">田中先生</div>
              </div>
