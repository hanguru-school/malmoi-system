...
import { BookOpen, FileText, User, Calendar, Bell, Settings, LogOut } from 'lucide-react';
...
export default function LINEIntegrationPage() {
  ...
  const [activeTab, setActiveTab] = useState<'notes' | 'homework' | 'mypage' | 'booking'>('mypage');
  ...
  const handleTabChange = (tab: 'notes' | 'homework' | 'mypage' | 'booking') => {
    setActiveTab(tab);
  };
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full mx-4">
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-2">LINE 연동 오류</h1>
        ...
        <div className="max-w-md mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="font-semibold text-gray-800">{lineUser.displayName}</h1>
        ...
        {!isLinked ? (
          <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
            <div className="text-center">
              ...
              <h2 className="text-xl font-bold text-gray-800 mb-2">계정 연동 필요</h2>
          ...
          <>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              {activeTab === 'notes' && (
                <div>
                  <h2 className="text-xl font-bold text-gray-800 mb-4">노트 보기</h2>
                  <div className="space-y-3">
                    <div className="border rounded-lg p-3 hover:bg-gray-50 cursor-pointer">
                      <h3 className="font-semibold text-gray-800">기초 문법 노트</h3>
                      <p className="text-sm text-gray-600">2024년 1월 15일 수업</p>
                    </div>
                    <div className="border rounded-lg p-3 hover:bg-gray-50 cursor-pointer">
                      <h3 className="font-semibold text-gray-800">회화 표현 노트</h3>
                      <p className="text-sm text-gray-600">2024년 1월 12일 수업</p>
                    </div>
                    <div className="border rounded-lg p-3 hover:bg-gray-50 cursor-pointer">
                      <h3 className="font-semibold text-gray-800">단어 정리 노트</h3>
                      <p className="text-sm text-gray-600">2024년 1월 10일 수업</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'homework' && (
                <div>
                  <h2 className="text-xl font-bold text-gray-800 mb-4">숙제 하기</h2>
                  <div className="space-y-3">
                    <div className="border rounded-lg p-3 bg-yellow-50">
                      <h3 className="font-semibold text-gray-800">문법 연습 문제</h3>
                      <p className="text-sm text-gray-600 mb-2">마감: 2024년 1월 20일</p>
                    ...
                    <div className="border rounded-lg p-3 bg-green-50">
                      ...
                      <span className="text-green-600 text-sm">✓ 제출 완료</span>
                    </div>
                    <div className="border rounded-lg p-3">
                      <h3 className="font-semibold text-gray-800">단어 테스트</h3>
                      <p className="text-sm text-gray-600 mb-2">마감: 2024년 1월 25일</p>
                      <button className="bg-blue-500 text-white px-4 py-1 rounded text-sm hover:bg-blue-600">
                        시작하기
                      </button>
                    </div>
              ...
              {activeTab === 'mypage' && (
                <div>
                  <h2 className="text-xl font-bold text-gray-800 mb-4">마이페이지</h2>
                  <div className="space-y-4">
                    <div className="bg-blue-50 rounded-lg p-4">
                      <h3 className="font-semibold text-gray-800 mb-2">학습 현황</h3>
              ...
              {activeTab === 'booking' && (
                <div>
                  <h2 className="text-xl font-bold text-gray-800 mb-4">예약 하기</h2>
                  <div className="space-y-4">
                    <div className="bg-green-50 rounded-lg p-4">
                      <h3 className="font-semibold text-gray-800 mb-2">다음 예약</h3>
                      <p className="text-sm text-gray-600">1월 18일 (목) 오후 2:00</p>
                      <p className="text-sm text-gray-600">김선생님 - 중급 문법</p>
                    </div>
                    
                    <div className="space-y-3">
                      <h3 className="font-semibold text-gray-800">예약 가능 시간</h3>
