...
class RoleBasedAccessControl {
  ...
  private initializeRoles() {
    ...
    const teacherRole: UserRole = {
      ...
      permissions: {
        pages: {
          '/teacher/home': { read: true, write: false, delete: false, admin: false },
          '/teacher/schedule': { read: true, write: true, delete: false, admin: false },
          '/teacher/lesson-notes': { read: true, write: true, delete: true, admin: false },
          '/teacher/curriculum': { read: true, write: true, delete: false, admin: false },
          '/student/notes': { read: true, write: false, delete: false, admin: false },
          '/student/homework': { read: true, write: false, delete: false, admin: false }
        },
        functions: {
    ...
    const staffRole: UserRole = {
      ...
      permissions: {
        pages: {
          '/staff/home': { read: true, write: false, delete: false, admin: false },
          '/staff/work-log': { read: true, write: true, delete: true, admin: false },
          '/staff/reports': { read: true, write: false, delete: false, admin: false }
        },
        functions: {
    ...
    const studentRole: UserRole = {
      ...
      permissions: {
        pages: {
          '/student/home': { read: true, write: false, delete: false, admin: false },
          '/student/reservations': { read: true, write: true, delete: true, admin: false },
          '/student/notes': { read: true, write: false, delete: false, admin: false },
          '/student/homework': { read: true, write: true, delete: false, admin: false },
          '/student/mypage': { read: true, write: true, delete: false, admin: false },
          '/student/learning-stats': { read: true, write: false, delete: false, admin: false }
        },
        functions: {
   ...
   * 페이지 접근 권한 확인
   */
  checkPageAccess(roleType: string, pagePath: string, action: 'read' | 'write' | 'delete' | 'admin' = 'read'): boolean {
   ...
   * 데이터 접근 권한 확인
   */
  checkDataAccess(roleType: string, dataType: keyof RolePermissions['dataAccess']): boolean {
    const role = this.roles.get(roleType);
    if (!role) return false;
   ...
   * 특별 권한 확인
   */
  checkSpecialPermission(roleType: string, permissionName: keyof RolePermissions['specialPermissions']): boolean {
    const role = this.roles.get(roleType);
    if (!role) return false;
  ...
  createAuthMiddleware() {
    return (req: Record<string, unknown>, res: Record<string, unknown>, next: Record<string, unknown>) => {
  ...
  createAuthHook() {
    return (userRole: string) => {
      return {
        canAccessPage: (pagePath: string, action: 'read' | 'write' | 'delete' | 'admin' = 'read') => 
        ...
        hasSpecialPermission: (permissionName: keyof RolePermissions['specialPermissions']) => 
