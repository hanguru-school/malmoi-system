...
interface LearningProgress {
  ...
  weeklyData: { week: string; classes: number; homework: number; words: number }[];
}
...
export default function StudentMotivationPage() {
  ...
  const [activeTab, setActiveTab] = useState<'progress' | 'badges' | 'recommendations' | 'feedback'>('progress');
    ...
    const initializeData = async () => {
      ...
      const mockRecommendations: Recommendation[] = [
        {
          ...
          type: 'review',
          title: '복습이 필요한 문법',
          description: '조동사 "can"과 "could"의 차이점을 다시 한번 복습해보세요.',
          priority: 'high',
        ...
        },
        {
          ...
          type: 'practice',
          title: '추천 연습 문제',
          description: '이번 주 학습한 내용을 바탕으로 한 연습 문제를 풀어보세요.',
          priority: 'medium',
        ...
        },
        {
          ...
          type: 'goal',
          title: '이번 주 목표',
          description: '새로운 단어 20개를 학습하고 문법 연습 문제 3개를 완료하세요.',
          priority: 'medium'
        },
        {
          id: '4',
          type: 'reminder',
          title: '다음 수업 준비',
          description: '내일 오후 2시 수업이 있습니다. 오늘 배운 내용을 미리 복습해보세요.',
          priority: 'low'
        }
      ];
      ...
      const mockFeedback: FeedbackSummary = {
        recentFeedback: [
          {
            date: '2024-01-15',
            content: '문법 설명이 매우 명확했습니다. 실습도 충분히 할 수 있어서 좋았습니다.',
            rating: 5
          },
          {
            date: '2024-01-12',
            content: '회화 연습이 재미있었고, 선생님이 친절하게 가르쳐주셨습니다.',
            rating: 5
          },
          {
            date: '2024-01-08',
            content: '단어 학습이 체계적이었고, 예문을 통해 이해하기 쉬웠습니다.',
            rating: 4
          }
        ],
        averageRating: 4.7,
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">학습 동기부여</h1>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          {activeTab === 'progress' && (
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-6">학습 진도 현황</h2>
              ...
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-6 text-white mb-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-blue-100">현재: {learningProgress.currentLevel} → 다음: {learningProgress.nextLevel}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-2xl font-bold">{learningProgress.progressToNextLevel}%</p>
                ...
                <div className="w-full bg-blue-400 rounded-full h-3">
                  <div 
                    ...
                    style={{ width: `${learningProgress.progressToNextLevel}%` }}
                  ></div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  <div className="text-2xl font-bold text-blue-600">{learningProgress.totalClasses}</div>
                  <div className="text-sm text-gray-600">총 수업</div>
                </div>
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600">{learningProgress.completedHomework}</div>
                  <div className="text-sm text-gray-600">완료 숙제</div>
                </div>
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  <div className="text-2xl font-bold text-purple-600">{learningProgress.totalWords}</div>
                  <div className="text-sm text-gray-600">학습 단어</div>
                </div>
                <div className="text-center p-4 bg-orange-50 rounded-lg">
                  <div className="text-2xl font-bold text-orange-600">{learningProgress.totalGrammar}</div>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">주별 학습 현황</h3>
                  ...
                  {learningProgress.weeklyData.map((week, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex items-center space-x-6">
                        <div className="text-center">
                          <p className="text-sm font-medium text-blue-600">{week.classes}회</p>
                          <p className="text-xs text-gray-500">수업</p>
                        </div>
                        <div className="text-center">
                          <p className="text-sm font-medium text-green-600">{week.homework}개</p>
                          <p className="text-xs text-gray-500">숙제</p>
                        </div>
                        <div className="text-center">
                          <p className="text-sm font-medium text-purple-600">{week.words}개</p>
          ...
          {activeTab === 'badges' && (
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-6">획득한 배지</h2>
                ...
                {badges.map((badge) => (
                  ...
                  >
                    <div className="text-center">
                      ...
                      <h3 className={`font-semibold mb-1 ${badge.isEarned ? 'text-gray-900' : 'text-gray-500'}`}>
                        {badge.name}
                      </h3>
                      <p className={`text-sm mb-2 ${badge.isEarned ? 'text-gray-600' : 'text-gray-400'}`}>
                        {badge.description}
                      </p>
                      {badge.isEarned ? (
          ...
          {activeTab === 'recommendations' && (
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-6">맞춤형 추천</h2>
          ...
          {activeTab === 'feedback' && (
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-6">학습 피드백 요약</h2>
              ...
              <div className="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-lg p-6 text-white mb-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-yellow-100">총 {feedbackSummary.totalFeedback}개의 피드백</p>
                  </div>
                  <div className="text-right">
                    <div className="flex items-center">
                      <Star className="w-6 h-6 text-yellow-200 mr-2" />
                      <span className="text-3xl font-bold">{feedbackSummary.averageRating}</span>
                    </div>
              ...
              {/* Recent Feedback */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">최근 피드백</h3>
                <div className="space-y-3">
