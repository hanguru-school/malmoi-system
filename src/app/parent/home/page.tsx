  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-4">
            <div>
              ...
              <div className="text-lg font-semibold text-gray-900">김부모님</div>
            </div>
          </div>
      ...
      <main className="p-4 sm:p-6 lg:p-8">
        {/* 환영 메시지 */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">안녕하세요, 김부모님!</h1>
          <p className="text-gray-600">오늘도 아이들의 학습 현황을 확인해보세요.</p>
        </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-200 cursor-pointer group">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors">{formatNumber(stats.totalChildren)}명</p>
                </div>
              </div>
            </div>
          </Link>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-200 cursor-pointer group">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900 group-hover:text-yellow-600 transition-colors">{formatCurrency(stats.totalPayments)}원</p>
                </div>
              </div>
            </div>
          </Link>
            ...
            {quickActions.map((action) => (
              <Link key={action.id} href={action.href} className="block">
                <div className="bg-white rounded-lg shadow-md p-4 hover:shadow-lg transition-all duration-200 cursor-pointer group">
                  <div className={`p-2 rounded-lg ${action.bgColor} w-fit mb-3 group-hover:scale-110 transition-transform`}>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/parent/activities" className="text-sm text-blue-600 hover:text-blue-700 flex items-center">
              모두 보기
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm font-medium text-gray-900">
                  시스템 상태: {stats.systemHealth === 'good' ? '정상' : stats.systemHealth === 'warning' ? '주의' : '오류'}
                </span>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                ...
                <div className="text-right">
                  <p className="text-sm font-medium text-gray-900">월요일 14:00</p>
              ...
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                ...
                <div className="text-right">
                  <p className="text-sm font-medium text-gray-900">수요일 16:00</p>
                  <p className="text-xs text-gray-500">1시간</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                ...
                <div className="text-right">
                  <p className="text-sm font-medium text-gray-900">금요일 15:00</p>
